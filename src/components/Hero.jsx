      ...
      >
        ...
        <div className="">
          <h1 className={styles.heroHeadText}>
            Hi, I'am <span className="text-[#915eff]">YASH</span>
          </h1>
          <p className={`${styles.heroSubText} mt-5 text-white `}>
            A college student who's addicted to caffeine, late-night coding
            sessions, and the occasional existential crisis. But hey, at least I
            know how to make a killer cup of coffee.
          </p>
        </div>
      </div>

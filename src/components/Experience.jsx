    ...
    icon={
      <div className="flex justify-center items-center w-full h-full">
        <img
          src={icon}
          alt={title}
          className="object-contain w-[70%] h-[70%] rounded-full"
        />
      </div>
    }
    date={date}
    ...
    <>
      <motion.div variants={staggerContainer}>
        <motion.p
          ...
          initial="hidden"
          whileInView="show"
          className={`${styles.sectionSubText} hover:underline hover:underline-offset-4 hover:decoration-purple-800 transition-all duration-500`}
        >
